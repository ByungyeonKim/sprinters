...
type CodeAttachModalInnerProps = {
  onSubmit: (data: { language: string; code: string }) => void;
  initialLanguage?: string;
  initialCode?: string;
};

function CodeAttachModalInner({ onSubmit, initialLanguage, initialCode }: CodeAttachModalInnerProps) {
