...
export type Student = Omit<RawStudent, 'mission_completions'> & {
  mission: number;
...
function formatStudent(student: RawStudent): Student {
...
function sortStudentsByMission(students: Student[]): Student[] {
